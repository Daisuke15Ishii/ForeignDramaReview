...
<div class="col-lg-8 mx-auto content-frame mb-4">
    <h1 class="content-title">マニュアル</h1>
    <div class="px-4 pt-1 pb-3">
        <div class="row">
            <div class="col-lg-12 mx-auto dramaindex-frame mb-4 pt-1">
                <h2>作品検索</h2>
                <div class="p-left">
            ...
            <div class="col-lg-12 mx-auto dramaindex-frame mb-4 pt-1">
                ...
                <div class="p-left">
                    ...
                    <p class="mb-3">また、気になったユーザーをフォローすることができます。フォローしたユーザーー一覧はマイページにてご覧いただけます。なお、いいね機能・フォロー機能はアカウント登録者のみ利用できます。</p>
                </div>
            </div>
            ...
            <div class="col-lg-12 mx-auto dramaindex-frame mb-4 pt-1">
                ...
                <div class="p-left">
                    ...
                    <div class="p-left">
                        <p class="mb-3">レビューコメントの削除はマイページからのみ行えます。また、レビュー削除ができる作品は、現在の進捗が「未分類」または「観たい」の作品に限ります。なお、レビュー削除を行うと自動的にマイページからも除外されます。レビュー削除をせずにマイページから除外することができません。</p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-12 mx-auto dramaindex-frame mb-2 pt-1">
                <h2>おすすめドラマ</h2>
                <div class="p-left">
