...
@section('content')
    <div class="row">
        ...
        {{--  ほぼほぼ新規アカウント作成のコピペなので、後で諸々修正予定。とりあえず変更できないようにactionを変更しているので注意 --}}
            <div class="card">
                <div class="card-header">設定の変更</div>

                <div class="card-body">
                    <form method="POST" action="{{ url('/user/mypage/setting/edit') }}">
                        @csrf
                    ...
                    <p>※反映ボタンを押すと、ご登録のメールアドレスに確認メールが届きます。</p>
                </div>
            </div>
