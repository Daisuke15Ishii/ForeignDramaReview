...
@section('content')
<div class="col-md-12 mx-auto content-frame">
    <h1 class="content-title">"{{ $cond_title }}"の検索結果{{ $alldrama->count() }}件</h1><span class="">({{ $dramas->firstitem() }}~{{ $dramas->lastitem() }}件目を表示)</span>
